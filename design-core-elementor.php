 ...
 * Description: Local-first AI design intelligence, reusable Elementor composition, HTML/Figma conversion, rendered visual verification and governed correction.
 * Version: 1.0.0-rc23
 * Author: Design Core
...
if ( ! defined( 'DESIGN_CORE_ELEMENTOR_VERSION' ) ) { define( 'DESIGN_CORE_ELEMENTOR_VERSION', '1.0.0-rc23' ); }
...
$files = array(
    ...
    'core/figma-transport.php', 'core/figma-normalization-service.php', 'core/figma-text-composer.php', 'core/figma-design-ir-adapter.php', 'core/figma-font-service.php', 'core/figma-fidelity-service.php',
