 ...
 * Description: Local-first AI design intelligence, persistent verified design memory, reusable Elementor composition, HTML/Figma conversion, rendered visual verification and governed correction.
 * Version: 1.0.0-rc25
 * Author: Design Core
...
if ( ! defined( 'DESIGN_CORE_ELEMENTOR_VERSION' ) ) { define( 'DESIGN_CORE_ELEMENTOR_VERSION', '1.0.0-rc25' ); }
...
$files = array(
    ...
    'core/fidelity-rule-registry.php', 'core/design-memory-store.php', 'core/failure-signature-engine.php', 'core/design-memory-retriever.php', 'core/benchmark-promoter.php', 'core/correction-learning-engine.php',
    ...
    'core/figma-raster-asset-resolver.php', 'core/figma-vector-asset-resolver.php', 'core/figma-transport.php', 'core/figma-normalization-service.php', 'core/figma-text-composer.php', 'core/figma-design-ir-adapter.php', 'core/figma-font-service.php', 'core/figma-geometry-verifier.php', 'core/figma-structure-verifier.php', 'core/figma-font-verifier.php', 'core/figma-responsive-verifier.php', 'core/figma-fidelity-service.php',
    'core/page-snapshot.php', 'core/site-intelligence.php', 'core/elementor-runtime-intelligence.php', 'core/design-agent-service.php', 'core/task-intelligence.php', 'core/compatibility-validator.php', 'core/production-readiness.php', 'core/registry-exporter.php', 'core/widget-generator.php', 'core/agent-gateway.php', 'core/cli.php',
...
if ( class_exists( 'Design_Core_Elementor_Design_Memory_Store' ) ) { ( new Design_Core_Elementor_Design_Memory_Store() )->ensure_seeded(); }
...
register_activation_hook( __FILE__, static function () { if ( class_exists( 'Design_Core_Elementor_Registry_Migrator' ) ) { ( new Design_Core_Elementor_Registry_Migrator() )->migrate(); } if ( class_exists( 'Design_Core_Elementor_Capabilities' ) ) { Design_Core_Elementor_Capabilities::migrate(); } if ( class_exists( 'Design_Core_Elementor_Design_Memory_Store' ) ) { ( new Design_Core_Elementor_Design_Memory_Store() )->ensure_seeded(); } } );
