...
$design_core_files = array(
    'includes/class-settings.php','includes/class-elementor-widget-inspector.php',
    ...
    'core/design-core-capabilities.php','core/remote-settings.php','core/remote-write-guard.php','core/remote-audit-log.php','core/machine-credential-registry.php','core/machine-credential-auth.php','core/preview-ticket-store.php','core/idempotency-store.php','core/api-access-settings.php','core/api-credential-registry.php','core/api-credential-auth.php',
    'core/fingerprint-service.php','core/section-fingerprint-service.php','core/registry-item-validator.php','core/versioned-registry.php','core/component-registry.php','core/section-registry.php','core/widget-registry.php','core/design-token-pipeline.php','core/design-token-service.php','core/agent-draft-writes.php','core/design-intelligence-catalog.php','core/design-system-profile.php','core/design-advisor.php','core/ux-quality-auditor.php','core/token-registry.php','core/registry-migrator.php',
    ...
    'core/css-auditor.php','core/visual-regression-service.php','core/screenshot-service.php','core/visual-feedback-engine.php','core/visual-correction-applier.php','core/visual-correction-service.php','core/visual-qa.php',
    'core/figma-transport.php','core/figma-normalization-service.php','core/figma-design-ir-adapter.php','core/design-benchmark-corpus.php','core/page-snapshot.php','core/site-intelligence.php','core/elementor-runtime-intelligence.php','core/task-intelligence.php','core/api-platform.php','core/api-platform-rest-controller.php','core/wordpress-owner-service.php','core/gpt-actions-api.php','core/gpt-actions-rest-controller.php','core/wordpress-mcp-compatibility.php','core/agent-gateway.php','core/mcp-ability-bridge.php','core/permissions.php','core/site-status.php','core/design-intelligence-rest-controller.php',
    'core/compatibility-validator.php','core/production-readiness.php','core/registry-exporter.php','core/widget-generator.php','core/rest-controller.php','core/rest-controller-v2.php','core/site-intelligence-rest-controller.php','core/cli.php',
    'includes/class-capability-scanner.php','includes/class-html-import-ui.php','includes/class-intelligence-admin.php','includes/class-remote-access-admin.php','includes/class-api-access-admin.php','includes/class-design-intelligence-admin.php','includes/class-plugin.php'
);
...
if ( class_exists( 'Design_Core_Elementor_Design_Intelligence_Admin' ) ) { Design_Core_Elementor_Design_Intelligence_Admin::boot(); }
if ( class_exists( 'Design_Core_Elementor_API_Access_Admin' ) ) { Design_Core_Elementor_API_Access_Admin::boot(); }
...
add_action( 'plugins_loaded', static function () {
    ...
    if ( class_exists( 'Design_Core_Elementor_Site_Intelligence_Rest_Controller' ) ) {
        add_action( 'rest_api_init', static function () {
            ( new Design_Core_Elementor_Site_Intelligence_Rest_Controller() )->register_routes();
        }, 20 );
    }
    if ( class_exists( 'Design_Core_Elementor_API_Platform_Rest_Controller' ) ) {
        add_action( 'rest_api_init', static function () {
            ( new Design_Core_Elementor_API_Platform_Rest_Controller() )->register_routes();
        }, 25 );
    }
    if ( class_exists( 'Design_Core_Elementor_GPT_Actions_Rest_Controller' ) ) {
        add_action( 'rest_api_init', static function () {
            ( new Design_Core_Elementor_GPT_Actions_Rest_Controller() )->register_routes();
        }, 30 );
    }
} );
